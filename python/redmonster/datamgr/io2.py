...
class Write_Redmonster:
    ...
    def create_hdulist(self):
        ...
        hdr = self.zpick.hdr
        hdr.extend([('VERS_RM','v0.1.0','Version of redmonster used'),('DATE_RM',strftime("%Y-%m-%d_%H:%M:%S", gmtime()),'Time of redmonster completion'), ('NFIBERS', len(self.zpick.z), 'Number of fibers'), ('NZ', len(self.zpick.z[0]), 'Number of redshifts retained'),('RCHI2_THRESH',self.zpick.threshold,'Reduced chi**2 threshold used')])
