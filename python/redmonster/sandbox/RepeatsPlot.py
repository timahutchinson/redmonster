...
class Repeatability:
    ...
    def makeSpAllRepeats():
        ...
        hdu = pyfits.open('/uufs/chpc.utah.edu/common/home/sdss02/ebosswork/eboss/spectro/redux/v5_7_13/spAll-v5_7_13.fits')
        ...
        newhdu.writeto(Repeatability.directory+'/spAll-v5_7_13-repeats_lrg.fits')

    @staticmethod
    def getDeltaVexistent():

        a = pyfits.open(Repeatability.directory+'/spAll-v5_7_13-repeats_lrg.fits')[1].data
