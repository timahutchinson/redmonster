...
p.plot(wave, redm[2].data[100][0]+.5, color='cyan')
...
p.plot(wave, redm[2].data[106][0]+1, color='cyan')
...
p.plot(wave, redm[2].data[96][0]+.5, color='cyan')
...
p.plot(wave, redm[2].data[64][0]+.5, color='cyan')
p.axis([wave[0],10000,0,2.5])
p.xlabel('Observed Wavelength ($\AA$)')
p.ylabel('$f_\lambda$ $10^{-17}$ erg cm$^{-2}$ s$^{-1}$ $\AA^{-1}$')
...
p.plot(wave, redm[2].data[63][0]+.5, color='cyan')
...
p.plot(wave, redm[2].data[75][0]+.5, color='cyan')
p.axis([wave[0],10000,-0.1,5.5])
p.xlabel('Observed Wavelength ($\AA$)')
p.ylabel('$f_\lambda$ $10^{-17}$ erg cm$^{-2}$ s$^{-1}$ $\AA^{-1}$')
