...
plate = 7848
mjd = 56959
fiberid = [266,267]#[i for i in xrange(1000)] # fiberid must be a list, not a numpy array
...
zssp1 = zfinder.Zfinder(fname='ndArch-ssp_galaxy_noemit-v000.fits', npoly=4, zmin=-0.01, zmax=1.2)
