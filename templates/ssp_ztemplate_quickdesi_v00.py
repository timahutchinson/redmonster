...
sdss_dloglam = 0.00005 # originally was 0.0001, changed to 0.00005 for DESI, variables left alone
...
# Velocity linewidth:
vline = 25. # assume 25 km/s, changed from 100 km/s
...
this_class = 'ssp_em_galaxy_quickdesi' # changed from what it was
this_version = 'v000'
