...
# This version made to work in tandem with v002_emit.
# Emission-line dimension scaled back relative to
# previous version, since ELG/AGN now represented in
# a complementary template file
